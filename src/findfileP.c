...
static int
pipe_open(const struct decompressor *dc, fpfile_t *fp)
{
	char *pipe_cmd;
...
static int
findfile_by_fullname(const char *fnam, const char *const *suffixes, fpfile_t *fp)
{
	int i;
	struct stat st;
	struct decompressor *dc;
...
static int
findfile_in_dir(const char *fnam, const char *dir, const int recdepth, const char *const *suf, fpfile_t *fp)
{
	DIR *d;
	struct dirent *de;
	char *ff, *fdir, *p;
...
int
findfile(const char *fnam, const char *const *dirpath, const char *const *suffixes, fpfile_t *fp)
{
	char *dir;
